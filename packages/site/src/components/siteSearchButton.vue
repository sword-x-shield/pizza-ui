...
.DocSearch {
  --docsearch-primary-color: var(--p-primary-1);
  --docsearch-highlight-color: var(--docsearch-primary-color);
  --docsearch-text-color: var(--p-color-text-1);
  --docsearch-muted-color: var(--p-color-text-2);
...
@media (min-width: 768px) {
  .DocSearch-Button {
    ...
    width: 100%;
    height: 40px;
    background-color: var(--p-primary-7);
  }

  .DocSearch-Button:hover {
    border-color: var(--vp-c-brand);
    background: var(--p-primary-6);
  }
}
